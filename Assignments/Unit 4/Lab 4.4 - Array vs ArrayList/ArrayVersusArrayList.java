...
public class ArrayVersusArrayList {
    ...
    public static void lastComesFirst(ArrayList<String> arrList) {
        if (arrList == null) {
            throw new IllegalArgumentException("arrList is null");
        }
        if (arrList.size() != 0) {
            ArrayList<String> arrList2 = new ArrayList<String>();
            arrList2.add(arrList.get(arrList.size() - 1));
            for (int i = 1; i < arrList.size(); i++) {
                arrList2.add(arrList.get(i - 1));
            }
            for (int i = 0; i < arrList.size(); i++) {
                arrList.set(i, arrList2.get(i));
            }
        }
    }
