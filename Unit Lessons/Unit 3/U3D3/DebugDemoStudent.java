...
public class DebugDemoStudent {
    ...
    public static int getFifthElement(int[] arr) {
        ...
        // exceptions: array can be less than 5 elements
        if(arr.length < 5) {
    ...
    public static int divideNumbers(int a, int b) {
        if (b == 0) {
            throw new ArithmeticException("You're dividing by 0.");
        }
        return a / b;
    }
    ...
    public static int middleNameLength(String[] names) {
        if (names[1] == null) {
            throw new NullPointerException("Names[1] is null");
        }
    ...
    public static double averageScore(int[] scores) {
        if (scores == null) {
            throw new IllegalArgumentException("Array scores is null");
        }
        int sum = 0;
    ...
    public static String stringEnds(String str, int n) {
        if (str.length() < n) {
            throw new IllegalArgumentException("str.length() < n");
        }
